...
class Export_tmf(bpy.types.Operator, bpy_extras.io_utils.ExportHelper):
    ...
    use_strict: bpy.props.BoolProperty(
        ...
        description=(
            ...
            "at most one material slot per mesh; no loose/disconnected vertices; "
            "absolute world extents Y in [-3, 3] mm and Z in [-0.3, 2.2] mm; "
            "vertex count within Poly Target; Diffuse.dds / Details.dds texture references. "
